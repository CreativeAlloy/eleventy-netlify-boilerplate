---
title: Large Language Models Burn Propallies to Pieces
serious: true
lecture: false
date: 2026-06-20T16:21:00Z
author: Sufian M′Barki
summary: Sometimes catharsis means watching an LLM lose its shit over modern-day
...
tags:
  ...
  - westerncult
---
![This LLM writes a sermon cursing those who stand with terrorists and Islam, uncensored.](/static/img/mistralcrashout.png "Mistral NeMo Crashing Out Over Pisslamist Ass-Lickers")

You may not know that Large Language Models can be uncensored, but they certainly can. Mistral NeMo is one example of a local, open-weights uncensored LLM option, and it can quite literally generate anything you ask for - which is no different from writing it yourself.

I once (oh, as if it has happened only once in this bloody world) had the major displeasure of encountering an alleged "Christian" from Lebanon who was spreading pro-Hezbollah propaganda, and of course, antisemitism.

Nothing is more indicative of societal decline than widespread antisemitic vitriol and condoning terrorism. We have people excusing (and even endorsing) antisemitism because, "You can't talk about antisemitism when Israel is **(allegedly)** committing genocide."

Oh, we most certainly can talk about antisemitism. Even if Israel were actually doing it, little Moshe in London would have diddly-squat to do with that. How come innocent Jews in your vicinity just so happen to be the object of your hate speech and physical violence, oftentimes even outright murder? How does that address this **(alleged)** genocide?
...
The worst part is that [Israel is not even committing genocide.](https://thewaspalloy.org/posts/what-in-nirvana-am-i-witnessing/#:~:text=%5B4%5D%20There%20is%20no%20genocide%20in%20Gaza%20carried%20out%20by%20the%20IDF%20nor%20Israel%3A) And it is the worst part because it reveals everything about these so-called "activists" to the extent where claiming one "cannot see it" is **feigned ignorance and incompetence.** Israel "committing genocide" is nothing more than the modern-day social excuse to bash Jews. We've heard the same spiel countless times in history. "Jews killed Jesus, Jews stole our money, Jews drink blood, Jews are witches, Jews this, Jews that."
