...
tags:
  ...
  - antisemitism
---
![Critical Thinking Fundamentals - Introduction](/static/img/ctf.png "Critical Thinking Fundamentals - Introduction")

[The lecture can be accessed here.](https://thewaspalloy.org/posts/critical-thinking-fundamentals-introduction/) The information from it is required in order to understand the examples in this seminar.
...
[First, UNESCO *(mighty ironic)* define the term as, "referring to the original inhabitants of a region, particularly those who maintain cultural, social, and historical ties to their ancestral lands."](https://www.unesco.org/en/query-list/i/indigenous#:~:text=%22Indigenous%22%20refers%20to%20the%20original,and%20traditions%20of%20Indigenous%20Peoples.)
...
![Diagram showcasing that Indigenous Peoples is the broad category that Jews belong to.](/static/img/deduction-1.png "Deduction #1 Illustrated")
...
Let's begin with the definition of apartheid. [According to Merriam-Webster, apartheid refers to racial segregation.](https://www.merriam-webster.com/dictionary/apartheid) Specifically, the term originates from South Africa as a policy from last century, where significant socio-political segregation against the non-white population of SA was exercised. Fortunately, this does not seem to be the case today.
...
After a quick Google search, I discovered that [the Sheba Medical Center's prominent nurse and medical coordinator in the Financial Department is named Khaled Assaf, who speaks Arabic, Hebrew, and English.](https://www.shebaonline.org/team-2/)

![Medical personnel web card showcasing HCP Khaled Assaf's credentials and contact details.](/static/img/khaledassafcard.png "Khaled Assaf Web Card")
...
![Medical personnel web card showcasing HCP Jozef Barokas' credentials and contact details.](/static/img/jozefbarokascard.png "Jozef Barokas Web Card")
...
2. **Premise:** Israeli hospitals house diverse healthcare professionals.
3. **Premise:** Israel's government houses Arab and Muslim political parties.
4. **Conclusion:** Israel is an apartheid state.
...
Everyone has a responsibility to educate themselves and verify if their premises are factually correct. All I did was a few quick Google searches just to provide evidence for this lesson. I did not invoke my long-standing knowledge on Israel, nor did I cite [my Pastebin document (until now anyway).](https://pastebin.com/uTT91J3B)
