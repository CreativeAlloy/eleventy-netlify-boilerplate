---
title: "Critical Thinking Fundamentals - Conditional Reasoning: Seminar"
serious: false
lecture: true
date: 2026-08-29T11:08:00Z
author: Sufian M′Barki
summary: Let us take a look into detailed examples of applied conditional
  reasoning in the realm of Hasbara activism.
tags:
  - lecture
  - seminar
  - logic
  ...
  - antisemitism
---
![Critical Thinking Fundamentals - Conditional Reasoning](/static/img/ctf2cr.png "Critical Thinking Fundamentals - Conditional Reasoning")

We previously explored the core principles behind Conditional Reasoning in the Critical Thinking Fundamentals series. [You may revise the material here, as the knowledge from the lecture is required for this seminar.](https://thewaspalloy.org/posts/critical-thinking-fundamentals-conditional-reasoning/)

## Conditional Reasoning in Hasbara

I believe that the greatest strength of Hasbara activism is its ability to ground itself in formal logic. Writing conditional syllogisms offers different rhetorical possibilities compared to categorical ones, which serves to fortify our case even further.
...
What if several conditions are necessary in order for their combined truthfulness to be sufficient for a consequent?
...
If there are multiple sufficient conditions that fulfill the truthfulness of the consequent by themselves, combining them in a logical operation is called an **Inclusive Disjunction.**
...
With text: **Either J, or M, or N leads to I.**

## Antizionism is Antisemitism

This particular thesis can be proven using both categorical and conditional reasoning, but we will only explore a conditional syllogism for the time being.

Like before, we must begin by establishing all objective definitions of the terms we are using.

[The American Jewish Committee remains one of the few sources that correctly describe Zionism as a liberation movement. More specifically, it is an ideology to re-establish and support the existence of a Jewish state in the Biblical Land of Israel. Likewise, a Zionist is someone who supports Jews' right to self-determination in their historical homeland, and Israel's right to exist.](https://www.ajc.org/translatehate/Zionist)

We can use **Applied Epistemology** to prove this definition is correct.

In short, [**epistemology** is the philosophical discipline of studying knowledge, and its principles can be used to confirm why anything we believe to be true is genuinely true.](https://en.wikipedia.org/wiki/Epistemology) It is completely immune to handwaving and other fallacious rhetorical tactics.

In an upcoming lecture-seminar pair on epistemology, we will dive much deeper into this branch of philosophy.

### The Various Narratives on Zionism

The prevailing narrative on the definition of Zionism is that, allegedly, it represents an ethnonationalist movement that seeks to establish a Jewish State in the historical land of Palestine, ensuring the population is as Jewish as possible with as few "Palestinians" (Arabs) as possible.

The glaring problem is that this description does not match reality. [Quoting directly from the previous seminar:](https://thewaspalloy.org/posts/critical-thinking-fundamentals-introduction-seminar/)
...
> 
> *This showcases that Arabic and Turkish speakers are able to occupy incredibly important medical positions. Khaled Assaf is an especially important example, [as his name is completely Arabic.](https://share.google/aimode/ZDxhPUpeKiglK5IdG)*
> 
> *Within the Knesset, which is essentially Israel's government, numerous political parties exist, [most notably the Ra'am Party - an Arab party with roots in the Islamic movement.](https://israelpolicyforum.org/wp-content/uploads/2022/09/Israels-Political-Parties-and-Breakdown-of-the-Outgoing-Knesset-2022.pdf) Their leader is Mansour Abbas, [which is a traditional Arabic name as well.](https://share.google/aimode/dn3rkBbSPGb3HwYaD)*
> 
...
Given the comprehensive evidence of Arab presence in Israel, as well as their possession of full rights alongside Jews, it becomes extremely difficult to maintain the idea that Zionism is an "ethnic cleansing" movement.

Jews are also indigenous to Israel, as proven by the categorical deductive syllogism in that same seminar:
> *Secondly, [the Kingdoms of Israel and Judah are ancient. They have existed for about 3000 years, and their Jewish population has been ever-present in the region up until this day.](https://www.perplexity.ai/search/36fcd4b7-5fc2-4ed7-822d-45b3bfc27ff1) Jews have preserved their religion, their language, and all of their traditions.*
>
> *(...)*
>
...
Now, since the re-establishment of Israel in 1948 all the way up until today, Israel has granted full rights to all ethnic groups, which matches its Declaration of Independence[<sup>[1]</sup>](#cite-1).

**The conclusion is inescapable: Zionism cannot be an ethnic cleansing movement given Israel's Ancient history, present-day reality, and its explicit Declaration of Independence that is based on Zionism. Instead, it is a liberation movement that seeks to re-establish Israel and grant all Jews worldwide safety and security from foreign oppression.**

### Resuming the Conditional Syllogism

Now that we have proven beyond any doubt that Zionism is a Jewish movement for self-determination and sovereignty, we can continue our conditional syllogism.
...
Only one of them needs to be true in order to trigger the truthfulness of L (antisemitism).
