---
title: Critical Thinking Fundamentals - Introduction
serious: false
lecture: true
date: 2026-04-28T14:12:00Z
author: Sufian M′Barki
summary: With the addition of lectures, let us dive into the world of the
  philosophical discipline named logic, a.k.a. critical thinking.
tags:
  - lecture
  - logic
  - journalism
...
[Logic is the study of reasoning.](https://en.wikipedia.org/wiki/Logic) This discipline includes both a formal and an informal branch. Both branches will be explored together in the Critical Thinking Fundamentals series. **In any case, the overarching truth about logic is that it aims to teach the principles of sound reasoning.**
...
[In a world increasingly plagued by idiotic takes on Israel](https://thewaspalloy.org/posts/debunking-%22talmud%22-antisemitic-lies/), there is no better time and place than right here and now to get started.
...
1. **Premise:** All mammals have lungs.
...
Another example:
1. **Premise:** All mammals live on land.
2. **Premise:** Whales live in the ocean.
3. **Conclusion:** Whales are not mammals.
...
1. **Premise:** Mammals live on land and in the ocean.
2. **Premise:** Whales live in the ocean.
3. **Conclusion:** **Whales may or may not be mammals.**
...
[As summarized here:](https://share.google/aimode/53fSO1deJURrAPZ8D)
...
You can always browse academic literature to learn more, but the core advantage of reading about it on **The Wasp Alloy** is the ability to see how I apply it in my Hasbara activism.
