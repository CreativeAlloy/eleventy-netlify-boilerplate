...
The Perplexity summary I linked to claims that none of the sources "confirm this is a genocide against Christians," but this has to do with artificial intelligence' inherent bias for academic consensus. I specifically asked Perplexity to avoid citing the United Nations, because it's nothing more than a Jihadist network cosplaying as a human rights organization[[1]](#cite-1). This gave slightly less misleading results, but either way, the consensus bias is blatantly obvious.
...
If a genocide is the targeted, intentional erasure of a people based on their national, cultural, and/or religious identity, like what Hitler did to Jews just last century; and violently overthrowing Christianity, Judaism, polytheist religions, etc. is quite literally a mandate in the Quran itself[[3]](#cite-3), there is no room for "consensus" that the actions of Muslim factions in those territories are not, in fact, a genocide.
...
[Perplexity provides a comprehensive summaryh of specific Quranic verses proving this.](https://www.perplexity.ai/search/may-i-task-you-with-finding-re-7pLtkxg2Q_C48gu1C5vWcw) Most notably:
